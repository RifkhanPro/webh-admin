...
function ViewAnalytics() {
	...
	// Post Count
	useEffect(() => {
		fetch('https://18.205.10.114:8070/postManagement/posts')
			.then(res => {
				return res.json()
			})
			.then(resp => {
	...
	// Blog Count
	useEffect(() => {
		fetch('https://18.205.10.114:8070/blog')
			.then(res => {
				return res.json()
			})
			.then(resp => {
	...
	// Article Count
	useEffect(() => {
		fetch('https://18.205.10.114:8070/article')
			.then(res => {
				return res.json()
			})
			.then(resp => {
	...
	// Topic Count
	useEffect(() => {
		fetch('https://18.205.10.114:8070/topic/topics')
			.then(res => {
				return res.json()
			})
			.then(resp => {
	...
	// Topic Count
	useEffect(() => {
		fetch('https://18.205.10.114:8070/topicPost/topicPosts')
			.then(res => {
				return res.json()
			})
			.then(resp => {
	...
	// Advertistment Count
	useEffect(() => {
		fetch('https://18.205.10.114:8070/advertisement')
			.then(res => {
				return res.json()
			})
			.then(resp => {
	...
	// News Count
	useEffect(() => {
		fetch('https://18.205.10.114:8070/news')
			.then(res => {
				return res.json()
			})
			.then(resp => {
	...
	// User Count
	useEffect(() => {
		fetch('https://18.205.10.114:8070/user')
			.then(res => {
				return res.json()
			})
			.then(resp => {
